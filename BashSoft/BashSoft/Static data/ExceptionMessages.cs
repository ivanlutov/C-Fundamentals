namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "You are unable to go higher in the hierarchy of the current partition.";
        ...
        //public const string NotEnrolledInCourse = "SoftUniStudent must be enrolled in a course before you set his mark.";
